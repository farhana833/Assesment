...
Route.group(() => {
  ...
  Route.group(() => {
    ...
    Route.post('/insertdep', 'DepartmentsController.insertdep');
    Route.patch('/updatedep', 'DepartmentsController.updatedep');
    Route.delete('/deletedep', 'DepartmentsController.deletedep');
  })
