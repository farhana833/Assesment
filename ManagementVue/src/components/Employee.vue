        ...
        <div class="table-title">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <RouterLink to="/Empform"
                ><button class="btn btn-info add-new">
                  Add Data
                </button></RouterLink
              >
            </div>
...
export default {
  ...
  mounted: async function () {
    ...
    const depnames = await this.instance.get("/selectdep");
  ...
  methods: {
    ...
    async filterval() {
      const tableDetails = await this.instance.get("/selectemp");
      if (this.value == null) {
        ...
        this.alldetails = tableDetails.data.filter((el) => {
          return el.depart_id == this.value;
        })};
    },
    clearForm() {
      this.name = "";
