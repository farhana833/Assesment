    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="name"><h2> <b>Employee management</b></h2></div>
                    <div class="form"><router-link to="/Empform"><button>Add Data</button></router-link></div>
                    <div class="col-sm-4">
...
export default {
  ...
  methods: {
    ...
    deleteRow(inputid) {
       ...
       this.instance.delete("/deleteemp", { data: { id: inputid}}).then((result)=> {
